...
--
	...
	vstudio.vs200x_architectures =
	{
		...
		x86     = "x86",
		x86_64  = "x64",
		xbox360 = "Xbox 360", --pe:akovalovs: from what I can tell, this name has to match Visual Studio platform name
		psvita = "PSVita",
		orbis = "ORBIS"
	}
	--pe:akovalovs: the struct below is used for visual studio 2010+, but the code falls back on 200x struct if not found
