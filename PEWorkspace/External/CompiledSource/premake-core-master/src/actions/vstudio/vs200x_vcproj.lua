...
---
	...
	m.elements.tools = function(cfg)
		...
		--pe:akovalovs: do we need custom set of tools for PSVita PS4?
...
---
	...
	function m.VCCLCompilerToolName(cfg) --pe:akovalovs: doesn't look like this function is ever called
		...
		elseif prjcfg and prjcfg.system == p.XBOX360 then
			...
			--pe:akovalovs: do we need custom copiler tool for PSVita or PS4?
	...
	function m.VCLinkerToolName(cfg) --pe:akovalovs: doesn't look like this function is ever called
		if cfg.kind == p.STATICLIB then
			return "VCLibrarianTool"
		elseif cfg.system == p.XBOX360 then
			return "VCX360LinkerTool"
		else
			--pe:akovalovs: do we need custom linking tool
			return "VCLinkerTool"
		end
	end
...
---------------------------------------------------------------------------
	...
	function m.enableEnhancedInstructionSet(cfg)
		...
		--pe:akovalovs: do we need anything special here for PSVita or PS4?
