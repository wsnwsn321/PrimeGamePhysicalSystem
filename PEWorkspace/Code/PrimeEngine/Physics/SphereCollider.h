#pragma once
#ifndef __PYENGINE_2_0_SPHERE_COLLIDER_
#define __PYENGINE_2_0_SPHERE_COLLIDER_
// API Abstraction
...
namespace PE {
	namespace Components
	{
		...
		{
			PE_DECLARE_CLASS(SphereCollider); // creates a static handle and GteInstance*() methods. still need to create construct

			SphereCollider(PE::GameContext &context, PE::MemoryArena arena, PE::Handle hMyself) : PhysicsComponent(context, arena, hMyself)
			{}
